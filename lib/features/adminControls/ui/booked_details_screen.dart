  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        title: Text("Booked Details",style: TextStyles.font18blackbold,),
        centerTitle: true,
      ),
        ...
        children: [
          ...
          Column(
            ...
            child: Container(
              ...
              child: Center(
                child: Text("Approve",style: TextStyles.font14WhiteBold,),
              ),
            ),
          ),
           Padding(
            ...
            child: Container(
              ...
              child: Center(
                child: Text("Reject",style: TextStyles.font14blackbold,),
              ),
            ),
          )
            ],
