          ...
          return GestureDetector(
            onTap: () async {
              if (state.checkInHour != null &&
                ...
                log("ddddddddddddddddddddd ${roomModel?.update_booking}");
                if (roomModel?.update_booking == true) {
                  await getIt<BookingRoomCubit>().updateBooking(
                      UserBookingModel(
                        ...
                        BlocListener<BookingRoomCubit, BookingRoomState>(
                          ...
                          listener: (context, state) async {
                            if (state is BookingRoomSuccessState) {
                              CherryToast.success(
                                title: Text(" book is booked success"),
                              ).show(context);
                              context.pop();

                              if (roomModel?.book_id != null) {
                                getIt<NavigationBarCubit>()
